...
async function main() {
  console.log('Script started. Waiting 180s for rate limit reset...');
  await sleep(180000);
  console.log('Wait complete. Starting...');
  ...
  if (!nodes.length) { console.log('All done!'); return; }
...
main().catch(e => console.log('FATAL:', e.message)).finally(() => prisma.$disconnect());
